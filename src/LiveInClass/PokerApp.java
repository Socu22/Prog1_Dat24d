...
public class PokerApp {
	...
	public static void main(String[] args) {
		...
		Collections.shuffle(deck); //skifter kort rundt
		System.out.println(deck); //printer det
		...
		System.out.println(p2.highestCard());
		//System.out.println("noOfSpades: "+p1.noOfSpades());
		System.out.println("noOfSuit(Spar): "+p2.noOfSuit("Spar"));
		System.out.println("noOfSuit(Ruder): "+p2.noOfSuit("Ruder"));
		System.out.println("noOfSuit(Klør): "+p2.noOfSuit("Klør"));
		System.out.println("noOfSuit(Hjerter): "+p2.noOfSuit("Hjerter"));
		System.out.println(p2.flush());
